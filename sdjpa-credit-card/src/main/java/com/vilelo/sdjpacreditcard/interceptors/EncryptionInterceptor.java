package com.vilelo.sdjpacreditcard.interceptors;
...
public class EncryptionInterceptor implements Interceptor {
    ...
    public boolean onPersist(Object entity, Object id, Object[] state, String[] propertyNames, Type[] types) {
        ...
        Object[] newState = processFields(entity, state, propertyNames, "onPersist");
    ...
    public void onInsert(Object entity, Object id, Object[] state, String[] propertyNames, Type[] propertyTypes) {
        System.out.println("=== I'm in onInsert");
        Object[] newState = processFields(entity, state, propertyNames, "onInsert");
        Interceptor.super.onInsert(entity, id, newState, propertyNames, propertyTypes);
    }
