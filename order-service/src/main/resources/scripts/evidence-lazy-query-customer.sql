...
-- -- LAZY fetch type: If I don't call the customer object, Hibernate does not perfom that query
...
-- In the test I have this: orderHeader.getCustomer().getCustomerName()
-- only after that line the following query was performed
...
-- EAGER without the code to get customer entity:
-- I see that customer query was included in the call
select oh1_0.id,
       oh1_0.bill_to_address,
       oh1_0.bill_to_city,
       oh1_0.bill_to_state,
